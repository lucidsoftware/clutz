...
public class DeclarationGenerator {
  ...
  /**
   * Whether the author tried to express the concept of a namespace in Closure. TS has a first class
   * keyword for it, but in Closure we need to infer it from the JSDOC.
